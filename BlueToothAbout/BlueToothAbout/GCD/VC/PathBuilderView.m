...
//        CGPoint p2 =CGPointMake(20, 190);
//        CGPoint p3 =CGPointMake(30, 180);
//        CGPoint p4 =CGPointMake(40, 170);
...
//        [self.points addObject:xy1];
//        [self.points addObject:xy2];
//        [self.points addObject:xy3];
//        [self.points addObject:xy4];
//     [self updatePaths];
//    }
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if ([indexes count] > 0) {
      ...
      //  self.prospectivePointValue = pointValue;／／tian添加新点
    }
...
//        self.prospectivePointValue = nil;／／tian添加新点
    }
